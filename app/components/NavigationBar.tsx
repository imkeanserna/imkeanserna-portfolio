...
export default function NavigationBar() {
  ...
  return (
    <div className="fixed right-4 bottom-8 hsm:bottom-8 left-4">
      <div
        className={`mx-auto mt-8 flex h-[58px] w-max gap-2 rounded-2xl border border-border p-2 backdrop-blur-md ${theme === "dark" ? "supports-backdrop-blur:bg-black/10" : "supports-backdrop-blur:bg-white/10"
